package org.eclipse.birt.orgchart.chart.i18n;
...
public final class Messages
{
	 ...
	 *
	 */
	private static final String ORGCHART_EXAMPLES = "org.eclipse.birt.orgchart.chart.i18n.nls"; //$NON-NLS-1$

	private static final ResourceBundle RESOURCE_BUNDLE = UResourceBundle.getBundleInstance( ORGCHART_EXAMPLES,
			ULocale.getDefault( ),
	...
	public static ResourceBundle getResourceBundle( ULocale locale )
	{
		...
		if ( bundle == null )
		{
			bundle = UResourceBundle.getBundleInstance( ORGCHART_EXAMPLES,
				locale,
					SecurityUtil.getClassLoader( Messages.class ) );
