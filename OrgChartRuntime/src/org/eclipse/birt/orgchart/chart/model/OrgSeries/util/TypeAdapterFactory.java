 ...
 * $Id$
 */
package org.eclipse.birt.orgchart.chart.model.OrgSeries.util;
...
public class TypeAdapterFactory extends AdapterFactoryImpl {
	...
	protected TypeSwitch<Adapter> modelSwitch =
		new TypeSwitch<Adapter>() {
			@Override
			public Adapter caseOrgSeries(OrgSeries object) {
				return createOrgSeriesAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.eclipse.birt.orgchart.chart.model.OrgSeries.OrgSeries <em>Org Series</em>}'.
	 * <!-- begin-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createOrgSeriesAdapter() {
		return null;
	}
