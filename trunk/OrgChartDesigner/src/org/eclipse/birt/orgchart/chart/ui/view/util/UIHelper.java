package org.eclipse.birt.orgchart.chart.ui.view.util;
...
import orgchartdesigner.Activator;
...
public class UIHelper {
	...
	public static String getOrgTitle( int index )
	{
		switch ( index )
		{
			case 0 :
				return Messages.getString( "UIHelper.OrgExp.Id" ); //$NON-NLS-1$
			case 1 :
				return Messages.getString( "UIHelper.OrgExp.ParentId" ); //$NON-NLS-1$
			default :
				return ""; //$NON-NLS-1$
		}
	}
